    ...
    <body>
            ...
            <div class="formbold-form-wrapper">
                <form action="https://formbold.com/s/FORM_ID" method="POST">
                    <div class="formbold-input-flex">
                        ...
                        <div>
                            <select id="topic" name="topic" class="formbold-form-input" required>
                    ...
                    <div class="formbold-input-flex">
                        <div>
                            <select id="presentation_type" name="presentation_type" class="formbold-form-input" required>
                                <option value="">--Options--</option>
                                <option value="poster">poster</option>
                                <option value="oral">oral</option>
                            </select>
                            <label for="presentation_type" class="formbold-form-label"> presentation type </label>
                        </div>
                        <div>
                            <input
                            type="text"
                            ...
                            class="formbold-form-input"
                            />
                            <label for="presenter_name" class="formbold-form-label"> presenter name </label>
                        </div>
                        <div>
                            <input
                            type="text"
                            ...
                            class="formbold-form-input"
                            />
                            <label for="presenter_email" class="formbold-form-label"> presenter email </label>
                        </div>
                    </div>
                    
                    <div id="dynamicFields"></div>
                    <button type="button" id="addFieldBtn" class="formbold-btn">Add author</button>
        ...
        * {
        ...
        function createFieldGroup(author = {}) {
            ...
            fieldGroup.className = 'formbold-input-flex';
            ...
            const createField = (labelText, name, value = '') => {
                ...
                labelEl.className = 'formbold-form-label';
                labelEl.setAttribute('for', name + '_' + count);
                labelEl.textContent = labelText;

                const inputEl = document.createElement('input');
                inputEl.type = 'text';
                inputEl.className = 'formbold-form-input';
                inputEl.name = name + '[]';
                inputEl.id = name + '_' + count;
                inputEl.value = value;
            ...
            fieldGroup.appendChild(createField('Author name: ', 'author_name', author.name || ''));
            fieldGroup.appendChild(createField('Author email: ', 'author_email', author.email || ''));
            fieldGroup.appendChild(createField('Author affiliation: ', 'author_affiliation', author.affiliation || ''));

            const removeBtn = document.createElement('button');
            removeBtn.type = 'button';
            removeBtn.className = 'formbold-btn';
